...
const QUEUE_STEPS = [
  ...
  },
  {
    ...
    sub: "The staff is preparing your items.",
  },
  {
    key: "ready",
    icon: "✅",
    label: "Ready to Pick Up",
    sub: "Your order is ready! Please proceed to the counter.",
  },
  {
    key: "done",
    icon: "🎉",
...
const AdBanner = ({ isWide, adAnim, ads, navigation }) => {
  ...
  const filteredAds =
    ads && ads.length > 0
      ? ads.filter(
          (ad) => !ad.target || ad.target === "both" || ad.target === "visitor",
        )
      : [];
    ...
    filteredAds.length > 0
      ...
      : [
          ...
          },
          {
            ...
            emoji: "🥦",
            title: "Weekly Sale",
            sub: "Great prices on essentials!",
          },
        ];
  ...
  const mobileAnimStyle =
    !isWide && adAnim
      ? {
          overflow: "hidden",
          height: adAnim.interpolate({
            inputRange: [0, 1],
            outputRange: [0, 128],
          }),
          opacity: adAnim.interpolate({
            inputRange: [0, 1],
            outputRange: [0, 1],
          }),
          marginBottom: adAnim.interpolate({
            inputRange: [0, 1],
            outputRange: [0, 8],
          }),
        }
        ...
        if (
          ...
          if (Notification.permission === "granted") {
            ...
            Notification.requestPermission().then((p) => {
              if (p === "granted")
                new Notification("CESLA Grocery", { body: msg });
            });
          }
        }
      }
        ...
        >
          ...
          <View style={styles.headerCenter}>
            ...
            >
              ...
              {isWide ? "Grocery Ordering System" : "Grocery"}
            </Text>
            {isWide && (
          ...
          {menuOpen && (
            <View style={styles.dropdown}>
              {[{ icon: "📋", label: "My Order History", tab: "history" }].map(
                (opt) => (
                  <TouchableOpacity
                    key={opt.tab}
                    style={[
            ...
            >
              ...
              <View style={{ position: "relative", zIndex: 9999 }}>
                ...
                >
                  ...
                  <Text style={{ fontSize: 10, color: "rgba(1,31,75,0.55)" }}>
                    {sortDropOpen ? "▲" : "▼"}
                  </Text>
                </TouchableOpacity>
                {sortDropOpen && (
        ...
        <View style={[histStyles.panel, { zIndex: 100, flex: 2 }]}>
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 13, color: "#0f1e35" }}>
                {yearDropOpen ? "▲" : "▼"}
              </Text>
            </TouchableOpacity>
            {yearDropOpen && (
