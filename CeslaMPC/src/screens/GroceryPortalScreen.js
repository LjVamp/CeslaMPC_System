...
const ROLES = [
  {
    id: 'member',
    label: 'Member',
    description: 'Order groceries with your\nCESLA member account',
    icon: '👤',
    badge: null,
    accent: '#6fa3f7',
    screen: 'GroceryMemberScreen',
  },
  {
    id: 'visitor',
    label: 'Visitor',
    ...
    <View style={styles.root}>
      ...
      <Animated.View style={{
        ...
        <View style={[styles.header, {
          ...
          <View style={styles.headerCenter}>
            <Text style={[styles.headerH1, { fontSize: isWide ? 22 : isSmall ? 15 : 17 }]}
              numberOfLines={1} adjustsFontSizeToFit>
              <Text style={styles.headerGold}>CESLA </Text>
              Grocery Ordering System
            </Text>
            <Text style={[styles.headerSub, { fontSize: isWide ? 11 : 9 }]}
              numberOfLines={1} adjustsFontSizeToFit>
      ...
      >
        <View style={[styles.main, { paddingHorizontal: PAD }]}>
          ...
          <Animated.View style={[
            ...
            <Text style={[styles.taglineP, { fontSize: isWide ? 14 : 13 }]}>
              {'Welcome to '}
              <Text style={styles.taglineWhite}>CESLA Grocery!</Text>
        ...
        <Animated.View style={[styles.footer, { opacity: ftFade }]}>
          ...
          <Text style={[styles.footerP, { fontSize: 11 }]}>
            CESLA Multi-Purpose Cooperative  •  Grocery Ordering System  •  2026
          </Text>
        </Animated.View>
      </ScrollView>
    </View>
