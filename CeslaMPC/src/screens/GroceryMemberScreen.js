  ...
  return (
    ...
    >
      <Animated.View
        style={{
          flex: 1,
          backgroundColor: "rgba(1,15,40,0.80)",
          justifyContent: "center",
          alignItems: "center",
          opacity: fadeAnim,
        }}
        ...
        >
          ...
          <View
            style={{
              ...
              borderRadius: 110,
              overflow: "hidden",
              backgroundColor: "rgba(240,246,252,0.95)",
              borderWidth: 3,
        ...
        {deliveryType === "deliver" && (
          <View style={styles.totalRow}>
            ...
            >
              🛵 Delivery Fee{" "}
              {deliveryCoords
                ? `(${getDistanceKm(CANTEEN_LAT, CANTEEN_LNG, deliveryCoords.lat, deliveryCoords.lng).toFixed(1)} km)`
                : ""}
              :
            </Text>
            <Text
        ...
        <View style={styles.paymentModeBox}>
          ...
          <View style={styles.paymentModeRow}>
            ...
            >
              <View
                style={[
                  styles.radioOuter,
                  paymentMode === "credit" && styles.radioOuterActive,
                ]}
              >
              ...
              <Text
                style={[
                  styles.paymentModeText,
                  paymentMode === "credit" && styles.paymentModeTextActive,
                ]}
              >
                🪙 Credit
              </Text>
          ...
          {paymentMode === "credit" && (
            ...
            >
              ...
              >
                ⚠️ Credit orders will be charged to your member account and must
                be settled on payday.
              </Text>
            </View>
          )}
        </View>
...
const QUEUE_STEPS = [
  ...
  },
  {
    ...
    sub: "Your order is ready! Please proceed to the canteen.",
  },
  {
    key: "done",
    icon: "🎉",
    label: "Order Complete",
    sub: "Thank you for ordering!",
  },
];
...
const QueueStatusModal = ({
  ...
  if (minimized) {
    ...
    return (
      <View
        style={[qs.pill, { backgroundColor: pillColor }]}
      ...
      >
        ...
        >
          ...
          <Text style={qs.pillText}>
            Order #{orderNo} — {activeStep.label}
          </Text>
  ...
  return (
    ...
    >
      <Animated.View style={[qs.overlay, { opacity: fadeAnim }]}>
        ...
        />
        <Animated.View
          style={[qs.card, { transform: [{ translateY: slideAnim }] }]}
        >
          {/* Header */}
          ...
          <View style={qs.stepsRow}>
            {QUEUE_STEPS.filter((s) => s.key !== "done").map((step, i) => {
              const stepI = QUEUE_STEPS.filter((s) => s.key !== "done").indexOf(
                step,
              );
              const activeI = QUEUE_STEPS.filter(
                (s) => s.key !== "done",
              ).findIndex((s) => s.key === currentStatus);
                ...
                <React.Fragment key={step.key}>
                  <View style={qs.stepItem}>
                    ...
                    <Text
                      style={[
                        qs.stepLabel,
                        (done || active) && qs.stepLabelActive,
                      ]}
                    >
                      {step.label}
                    </Text>
          ...
          <View
            style={[
              qs.statusBox,
              currentStatus === "ready" && qs.statusBoxReady,
            ]}
          >
            ...
            <View style={{ flex: 1 }}>
              <Text
                style={[
                  qs.statusLabel,
                  currentStatus === "ready" && { color: "#27ae60" },
                ]}
              >
                {activeStep.label}
              </Text>
...
const AdBanner = ({ isWide, adAnim, ads, navigation }) => {
  ...
  const filteredAds =
    ads && ads.length > 0
      ? ads.filter(
          (ad) => !ad.target || ad.target === "both" || ad.target === "member",
        )
      : [];
          ...
          return (
            ...
            >
              {ad.image || ad.imageUrl ? (
                <Image
                  source={{ uri: ad.image || ad.imageUrl }}
                  style={{
                    position: "absolute",
                    top: 0,
                    left: 0,
...
export default function CanteenMemberScreen({ navigation }) {
  ...
  useEffect(() => {
    ...
    const found = orders.find(
      (o) => o.id === trackedOrderId || o.docId === trackedOrderId,
    );
    if (!found) return;
        ...
        if (
          ...
          if (Notification.permission === "granted") {
            ...
            Notification.requestPermission().then((p) => {
              if (p === "granted")
                new Notification("CLIMBS Canteen", { body: msg });
            });
          }
        }
      }
  ...
  const handlePlaceOrder = async (orderData) => {
    const orderNo =
      orderData.orderNo || Math.floor(1000 + Math.random() * 9000);
    const now = new Date();
    const time =
      now.toLocaleDateString("en-PH", {
        month: "short",
    ...
    const normalizedPayment =
      (orderData.paymentMode || "cash") === "credits"
        ? "credit"
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (
                !loginView &&
                member &&
                (mainTab === "history" || mainTab === "credit")
              ) {
      ...
      {loginView && (
        ...
        >
          ...
          >
            ...
            >
              CLIMBS Cooperative — Member Login
            </Text>
            {/* Hint */}
            <View
              style={{
            ...
            <View style={{ width: "100%", marginBottom: 10 }}>
              ...
              >
                ...
                />
                <TouchableOpacity
                  onPress={() => setLoginShowPw((p) => !p)}
                  style={{ padding: 6 }}
                >
                  <MaterialIcons
                    name={loginShowPw ? "visibility-off" : "visibility"}
                    size={20}
                    color="rgba(1,31,75,0.45)"
                  />
                </TouchableOpacity>
            ...
            >
              ...
              <Text
                style={{ fontFamily: "GoogleSans_700Bold", color: "#c9a84c" }}
              >
        ...
        ══════════════════════════════════════════════ */}
            ...
            {mainTab === "credit" &&
              (() => {
                ...
                const creditOrders = orderHistory.filter(
                  (o) =>
                    (o.payment || o.paymentMode || "").toLowerCase() ===
                    "credit",
                );
                    ...
                    >
                      ...
                      {creditTab === "unpaid" && unpaidOrders.length > 0 && (
                        ...
                        >
                          ...
                          >
                            ...
                            payday. Kontaka ang canteen admin para sa
                            settlement.
                          </Text>
                        </View>
                      )}
                      ...
                      {creditOrders.length === 0 ? (
                        ...
                        >
                          ...
                          >
                            {creditTab === "unpaid"
                              ? "Wala nay unsettled orders!"
                              : "Wala pay settled orders."}
                          </Text>
                        </View>
                      ) : (
                        <View style={tblStyle.tableWrap}>
                          ...
                          <View style={tblStyle.thead}>
                            <Text style={[tblStyle.hCell, { width: 110 }]}>
                              DATE / ORDER
                            </Text>
                            <View style={tblStyle.hDivider} />
                            <Text style={[tblStyle.hCell, { flex: 1 }]}>
                              ITEMS
                            </Text>
                            <View style={tblStyle.hDivider} />
                            <Text
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <View style={[tblStyle.cell, { width: 110 }]}>
                                    <Text style={tblStyle.ordNo}>
                                      #{order.orderNo || "—"}
                                    </Text>
                                    <Text style={tblStyle.ordDate}>
...
const HistoryTabContent = ({
  ...
  const sortedOrders = React.useMemo(() => {
    ...
    if (sortBy === "payment") {
      arr.sort((a, b) =>
        (a.payment || a.paymentMode || "cash")
          .toLowerCase()
          .localeCompare((b.payment || b.paymentMode || "cash").toLowerCase()),
      );
          ...
          {orderHistory.length === 0 ? (
            ...
            >
              ...
              {onShopNow && (
                ...
                >
                  <Text style={histStyles.shopNowText}>Order Now →</Text>
                </TouchableOpacity>
              )}
            </View>
          ) : (
